...
# RUN git clone https://github.com/ViTAE-Transformer/ViTPose && cd ViTPose && git checkout d521645 && pip install -e .
# RUN MMCV_WITH_OPS=1 pip install mmcv==1.3.9

RUN MMCV_WITH_OPS=1 pip install mmcv==2.1.0 -f https://download.openmmlab.com/mmcv/dist/cu117/torch2.0.0/index.html
RUN pip install mmdet==3.1.0 mmpose==1.3.0 mmengine==0.8.3
